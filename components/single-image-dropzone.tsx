...
const variants = {
  base: "relative rounded-md flex justify-center items-center flex-col cursor-pointer min-h-[150px] min-w-[200px] border border-dashed border-muted-foreground/40 transition-colors duration-200 ease-in-out",
  image:
        ...
        >
          ...
          {imageUrl ? (
            ...
            <div className="flex flex-col items-center justify-center text-xs text-muted-foreground">
              ...
              <div>Click or drag cover image here</div>
            </div>
          )}
